    ...
    <div style="float: left;">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="eamil" value="${condition.eamil[0]}" class="form-control" id="exampleInputEmail2" placeholder="jane.doe@example.com">
            </div>
...
<div>
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            <li class="disabled">
                <a href="javascript:false" aria-label="Previous">
            ...
            <c:forEach begin="1" end="${pb.totalPage}" var="i">
                ...
                <c:if test="${pb.currentPage >= pb.totalPage}">
                    <li class="disabled">
                        <a href="javascript:false;" aria-label="Next">
